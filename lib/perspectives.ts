    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Cette manière de voir avait sa logique dans un monde où les carrières étaient locales, les chaînes de valeur nationales et les équipes monoculturelles. Ce monde a disparu, discrètement mais complètement. Une PME industrielle du Grand Est achète en Asie, vend en Amérique du Nord et recrute au Maghreb. Une équipe marketing travaille chaque semaine avec des collègues, des agences et des plateformes de trois continents. Il n'y a plus de métier local. Il existe des métiers dont on n'a pas encore remarqué qu'ils sont devenus internationaux."
        ]
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Dans les métiers qui évoluent vite, le savoir le plus précieux n'a pas encore eu le temps d'entrer dans les manuels. Il vit dans les organisations : dans les décisions prises la semaine dernière, les erreurs de l'an passé, les méthodes qu'une équipe vient d'inventer parce que rien d'existant ne fonctionnait. Ce savoir appartient aux praticiens. Il se transmet dans les entreprises."
        ]
      },
      {
        ...
        paragraphs: [
          ...
          "Notre Faculty réunit des entrepreneurs, cadres, experts, chercheurs et consultants. Notre pédagogie mobilise aussi les organisations comme lieux et comme voix de la formation. Certaines choses ne s'apprennent nulle part ailleurs."
        ]
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Reste une question légitime : pourquoi une organisation consacrerait elle du temps à enseigner ? L'expérience donne des réponses constantes. Expliquer son métier à un regard extérieur oblige à le repenser. Les questions d'un groupe en formation sont souvent plus dérangeantes que celles d'un consultant. Les organisations qui enseignent rencontrent aussi celles et ceux qui feront le métier demain. Une institution de formation sérieuse donne à ce temps investi une vraie valeur pédagogique.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Le débat public pose souvent une question binaire : l'IA va remplacer tel métier ? La réalité observée dans les organisations est plus nuancée. Chaque métier est un assemblage de tâches. L'IA en absorbe certaines, en transforme d'autres et en crée de nouvelles. Le métier demeure, mais il se transforme. Le marketeur passe moins de temps à produire des variantes et plus de temps à juger, cadrer, arbitrer. Le juriste passe moins de temps à chercher et plus de temps à qualifier. Le formateur passe moins de temps à fabriquer des supports et plus à concevoir des situations.",
      ...
      },
      {
        ...
        paragraphs: [
          "Pour les organismes de formation et les établissements, la conclusion est exigeante. Il ne suffit pas d'ajouter un module « IA » au catalogue. Il faut revoir chaque programme et se demander ce que l'IA change dans le métier. Ce qui doit désormais être enseigné. Ce qui ne mérite plus autant de temps.",
