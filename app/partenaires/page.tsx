...
const publics = [
  { n: 'N 01', t: 'Entreprises', d: 'Accueillir un groupe, faire intervenir un dirigeant, animer une masterclass, concevoir un cas ensemble : les entreprises partenaires sont la faculté vivante de nos programmes.' },
...
const ways = [
  ...
  { n: 'R 03', t: 'Concevoir ensemble', d: 'Construire avec nous un programme, une expédition ou une publication au croisement de vos enjeux et de notre pédagogie.' }
];
      ...
      <header className="phero">
        <div className="wrap">
          ...
          <p className="lead">
            ...
            enseigner, prescrire, concevoir ensemble.
          </p>
        </div>
      </header>
